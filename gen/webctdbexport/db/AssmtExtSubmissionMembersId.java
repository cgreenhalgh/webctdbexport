...
/**
 * AssmtExtSubmissionMembersId generated by hbm2java
 */
@Embeddable
public class AssmtExtSubmissionMembersId  implements java.io.Serializable {
    ...
    @Column(name="NAME_N_PREFIX", nullable=false, length=96)
    ...
    @Column(name="NAME_N_SUFFIX", nullable=false, length=96)
