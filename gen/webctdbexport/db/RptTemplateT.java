...
/**
 * RptTemplateT generated by hbm2java
 */
@Entity
@Table(name="RPT_TEMPLATE_T"
)
public class RptTemplateT  implements java.io.Serializable {
    ...
    @Column(name="ASSESSMENT_COUNT", precision=20, scale=0)
    ...
    @Column(name="QUESTIONDB_QUESTION_COUNT", precision=20, scale=0)
    ...
    @Column(name="ASSIGNMENT_COUNT", precision=20, scale=0)
    ...
    @Column(name="CHAT_ROOM_COUNT", precision=20, scale=0)
    ...
    @Column(name="PAGE_COUNT", precision=20, scale=0)
    ...
    @Column(name="DISCUSSION_TOPIC_COUNT", precision=20, scale=0)
    ...
    @Column(name="LEARNING_MODULE_COUNT", precision=20, scale=0)
    ...
    @Column(name="MEDIA_LIBRARY_ENTRY_COUNT", precision=20, scale=0)
    ...
    @Column(name="ORGANIZER_PAGE_COUNT", precision=20, scale=0)
    ...
    @Column(name="URL_ENTRY_COUNT", precision=20, scale=0)
    ...
    @Column(name="SCO_COUNT", precision=20, scale=0)
    ...
    @Column(name="APP_BRIDGE_COUNT", precision=20, scale=0)
    ...
    @Column(name="SYLLABUS", precision=20, scale=0)
    ...
    @Column(name="PUBLIC_FLAG", precision=1, scale=0)
