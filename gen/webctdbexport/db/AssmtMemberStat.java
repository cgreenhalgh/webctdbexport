...
/**
 * AssmtMemberStat generated by hbm2java
 */
@Entity
@Table(name="ASSMT_MEMBER_STAT"
)
public class AssmtMemberStat  implements java.io.Serializable {


     private AssmtMemberStatId id;

    public AssmtMemberStat() {
    }

    public AssmtMemberStat(AssmtMemberStatId id) {
       this.id = id;
    }
    ...
    public AssmtMemberStatId getId() {
        return this.id;
    }
    
    public void setId(AssmtMemberStatId id) {
        this.id = id;
    }
