...
/**
 * AssmtClassSumStatId generated by hbm2java
 */
@Embeddable
public class AssmtClassSumStatId  implements java.io.Serializable {
    ...
    public AssmtClassSumStatId() {
    }

    public AssmtClassSumStatId(BigDecimal processId, BigDecimal deliveryContextId, BigDecimal assmtId, BigDecimal attempts, BigDecimal meanScore, BigDecimal medianScore, BigDecimal deviationScore) {
