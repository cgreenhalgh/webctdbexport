...
/**
 * AssmtItemGroupStatId generated by hbm2java
 */
@Embeddable
public class AssmtItemGroupStatId  implements java.io.Serializable {
    ...
    public AssmtItemGroupStatId() {
    }

    public AssmtItemGroupStatId(BigDecimal processId, BigDecimal deliveryContextId, BigDecimal assmtId, String memberGroup, BigDecimal assmtItemId, BigDecimal questionId, BigDecimal attempts, BigDecimal meanScore, BigDecimal medianScore, BigDecimal deviationScore, BigDecimal percentCorrectWhole, BigDecimal percentCorrectLower, BigDecimal percentCorrectUpper, BigDecimal correlation) {
