...
/**
 * UserAclV generated by hbm2java
 */
@Entity
@Table(name="USER_ACL_V"
)
public class UserAclV  implements java.io.Serializable {


     private UserAclVId id;

    public UserAclV() {
    }

    public UserAclV(UserAclVId id) {
       this.id = id;
    }
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="publicAcl", column=@Column(name="PUBLIC_ACL", nullable=false, precision=22, scale=0) ), 
        @AttributeOverride(name="publishedAcl", column=@Column(name="PUBLISHED_ACL", nullable=false, precision=22, scale=0) ) } )
    public UserAclVId getId() {
        return this.id;
    }
    
    public void setId(UserAclVId id) {
        this.id = id;
    }
