...
/**
 * PersonUnreadAnnouncement generated by hbm2java
 */
@Entity
@Table(name="PERSON_UNREAD_ANNOUNCEMENT"
)
public class PersonUnreadAnnouncement  implements java.io.Serializable {


     private PersonUnreadAnnouncementId id;

    public PersonUnreadAnnouncement() {
    }

    public PersonUnreadAnnouncement(PersonUnreadAnnouncementId id) {
       this.id = id;
    }
    ...
    public PersonUnreadAnnouncementId getId() {
        return this.id;
    }
    
    public void setId(PersonUnreadAnnouncementId id) {
        this.id = id;
    }
