...
/**
 * RptLearningContextSizeVId generated by hbm2java
 */
@Embeddable
public class RptLearningContextSizeVId  implements java.io.Serializable {
    ...
    public RptLearningContextSizeVId() {
    }

    public RptLearningContextSizeVId(BigDecimal learningContextId, BigDecimal totalSize, BigDecimal templateSize, BigDecimal additionalFileSize) {
    ...
    @Column(name="TOTAL_SIZE", nullable=false, precision=22, scale=0)
    ...
    @Column(name="ADDITIONAL_FILE_SIZE", nullable=false, precision=22, scale=0)
