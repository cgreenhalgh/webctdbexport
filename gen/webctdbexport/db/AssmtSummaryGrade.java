...
/**
 * AssmtSummaryGrade generated by hbm2java
 */
@Entity
@Table(name="ASSMT_SUMMARY_GRADE"
)
public class AssmtSummaryGrade  implements java.io.Serializable {


     private AssmtSummaryGradeId id;

    public AssmtSummaryGrade() {
    }

    public AssmtSummaryGrade(AssmtSummaryGradeId id) {
       this.id = id;
    }
    ...
    public AssmtSummaryGradeId getId() {
        return this.id;
    }
    
    public void setId(AssmtSummaryGradeId id) {
        this.id = id;
    }
